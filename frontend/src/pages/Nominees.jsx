              ...
              <div style={{ flex: 1 }}>
                ...
                {n.status === 'pending' && (
                  <button onClick={() => handleResend(n._id)}
                    style={{ marginRight: 8, padding: '5px 10px', background: 'transparent', border: '1px solid var(--border2)', borderRadius: 2, color: 'var(--muted)', fontSize: 10, cursor: 'pointer', letterSpacing: '0.08em' }}>
                    Resend
                  </button>
                )}
