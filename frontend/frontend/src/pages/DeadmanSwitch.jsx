        ...
        <div style={{ background: 'var(--card)', border: `1px solid ${getUrgencyColor()}`, borderRadius: 2, padding: 32, marginBottom: 24 }}>
          ...
          {status.triggered && status.contestDeadline && !status.contestCancelled && (
            <div style={{ marginBottom: 20, padding: '14px 16px', background: 'rgba(232,169,48,0.08)', border: '1px solid rgba(232,169,48,0.4)', borderRadius: 2 }}>
              <div style={{ fontSize: 12, color: '#e8c96a', marginBottom: 4, fontWeight: 500 }}>⏳ Contest Window Active</div>
              <div style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.6 }}>
                Your dead man's switch was triggered. You have <strong style={{ color: '#e8c96a' }}>{status.contestHoursLeft} hours</strong> to check in and cancel this alert. If you don't check in, nominees will be able to submit a death certificate.
              </div>
            </div>
          )}
