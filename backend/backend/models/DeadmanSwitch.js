...
const deadmanSchema = new mongoose.Schema({
  ...
  // 72-hour contest window — after trigger, owner has this long to cancel
  contestWindowHours:   { type: Number, default: 72 },
  contestDeadline:      { type: Date, default: null },   // set when triggered
